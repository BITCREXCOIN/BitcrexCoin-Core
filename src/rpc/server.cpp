...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop BITCREXCOIN server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "BITCREXCOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BITCREXCOIN features */
        {"bitcrexcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"bitcrexcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitcrexcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitcrexcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bitcrexcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bitcrexcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bitcrexcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitcrexcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"bitcrexcoin", "startmasternode", &startmasternode, true, true, false},
        {"bitcrexcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitcrexcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitcrexcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitcrexcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitcrexcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitcrexcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitcrexcoin", "preparebudget", &preparebudget, true, true, false},
        {"bitcrexcoin", "submitbudget", &submitbudget, true, true, false},
        {"bitcrexcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitcrexcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitcrexcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitcrexcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitcrexcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitcrexcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitcrexcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitcrexcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"bitcrexcoin", "mnsync", &mnsync, true, true, false},
        {"bitcrexcoin", "spork", &spork, true, true, false},
        {"bitcrexcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        // {"zerocoin", "getzbicseed", &getzbicseed, false, false, true},
        // {"zerocoin", "setzbicseed", &setzbicseed, false, false, true},
        // {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        // {"zerocoin", "searchdzbic", &searchdzbic, false, false, true},
        // {"zerocoin", "dzbicstate", &dzbicstate, false, false, true},
...
{
    return "> bitcrexcoin-cli " + methodname + " " + args + "\n";
}

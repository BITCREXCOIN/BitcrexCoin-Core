...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("00000edacd04f602008febcfcbfe9a4304bbf55da49e23592ccf8c58accdbc22"))
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1615484000, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04d0f93d16630720ed6d72d2a807fef1d92fdf001a2f3208d60170bbcff2dbef63dd05904aba20f1028414b0a442c5eb8382b6b53c2935dc987cb12e8cc5a59125");
        nDefaultPort = 36001;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // BITCREXCOIN starting difficulty is 1 / 2^12
        ...
        nMNCollateral = 500 * COIN;
        strDevpubkey = "020f8c77f3f16ce2d4c3c1c8571cc0dbff71d0f2f54c099d5f6b73893d70af58d4";

        /** Height or Time Based Activations **/
        nLastPOWBlock = 1000;
        nBitcrexCoinBadBlockTime = 1471401614;  // Skip nBit validation of Block 259201 per PR #915
        nBitcrexCoinBadBlocknBits = 0x1c056dac; // Skip nBit validation of Block 259201 per PR #915
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "BitcrexCoin Genesis Block 2021-03-12";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << std::vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04f82af9f2056236c5304f8c8e1875637cfc8851a349793668130953f17bbe18fb2c2a33278ffe16dc7970c846377ced49a0ddf7107202015613c4b0dd95e36abc") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = BlockMerkleRoot(genesis);
        genesis.nVersion = 1;
        genesis.nTime = 1615484000;
        genesis.nBits = 0x1e0ffff0;

        genesis.nNonce = 489625;

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x00000edacd04f602008febcfcbfe9a4304bbf55da49e23592ccf8c58accdbc22"));
        assert(genesis.hashMerkleRoot == uint256("0x96b6a8d6c57a69eefd61457c881f247690170fa8d18717716fe0f7714dbe33b1"));

        vSeeds.push_back(CDNSSeedData("bitcrex.xyz", "seed01.bitcrex.xyz")); // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("bitcrex.xyz", "seed02.bitcrex.xyz")); // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("bitcrex.xyz", "seed03.bitcrex.xyz")); // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("bitcrex.xyz", "seed04.bitcrex.xyz")); // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("bitcrex.xyz", "seed05.bitcrex.xyz")); // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("bitcrex.xyz", "seed06.bitcrex.xyz")); // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("bitcrex.xyz", "explorer.bitcrex.xyz")); // Primary DNS Seeder from Fuzzbawls
        ...
        strSporkPubKey = "04c57164438c5ec620e6698d6876efeb9c5b1924b9e6e0c2039acf7cb9331a0294813b1fea188861f1a59e5fe423262eafb2a1723de3f1e585afd9accf2d3e5f6f";
        strSporkPubKeyOld = "04327449545e620fe872e5dc9700f6e9d168220f2d9f41b4f0970b0e2119696b15ef9ac4fe0e0a7c8a56b2e7ce8666268ea80323e80655acab047b87df8443894e";
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zbic to be stakable
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("04a84bc56321dd4769a5d6e3aca405505cbf37500ead90d0ff9659f1589ebcb8dd276fc462e833c1ab44157b0b581a21f91513c250ada87370e8027b0f4538158f");
        nDefaultPort = 36003;
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nBitcrexCoinBadBlockTime = 1489001494;  // Skip nBit validation of Block 259201 per PR #915
        nBitcrexCoinBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        genesis.nTime = 1615484001;

        genesis.nNonce = 491707;

        hashGenesisBlock = genesis.GetHash();
        
        assert(hashGenesisBlock == uint256("0x0000063f455bb1b9f9154fce46c36fddc030da4f857cb06b0af6c0be719836cf"));
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 85);  // Testnet bitcrexcoin addresses start with 'b'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 18);   // Testnet bitcrexcoin script addresses start with '8'
        ...
        // Testnet bitcrexcoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet bitcrexcoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet bitcrexcoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        genesis.nTime = 1615484002;
        genesis.nNonce = 1;

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x2808e7c4598450300a358ed90f5397ac4fd18e2e7530457ec6bb333ceeeade61"));

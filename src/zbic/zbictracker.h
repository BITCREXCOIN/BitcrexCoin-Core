...
#ifndef BITCREXCOIN_ZBICTRACKER_H
#define BITCREXCOIN_ZBICTRACKER_H
...
public:
    CzBICTracker(std::string strWalletFile);
    ~CzBICTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzBICWallet* zBICWallet = NULL);
...
#endif //BITCREXCOIN_ZBICTRACKER_H

...
// Copyright (c) 2016-2019 The BITCREXCOIN developers
...
public:
    ...
    static bool HasZcTxesIfNeeded(const TransactionRecord& record) {
        return (record.type == TransactionRecord::ZerocoinMint ||
                ...
                record.type == TransactionRecord::ZerocoinSpend_Change_zBic ||
...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeZBIC:
        return tr("zBIC Stake");
    case TransactionRecord::StakeDelegated:
        return tr("BIC Cold Stake");
    case TransactionRecord::StakeHot:
        return tr("BIC Stake in behalf of");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted BIC to zBIC");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zBIC");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received BIC from zBIC");
    case TransactionRecord::ZerocoinSpend_Change_zBic:
        return tr("Minted Change as zBIC from zBIC Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zBIC to BIC");
    default:
        return QString();
    }
}
...
{
    QString str = BitcoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), wtx->bic + wtx->debit, false, separators);
    if (showUnconfirmed) {
...
QVariant TransactionTableModel::data(const QModelIndex& index, int role) const
{
    ...
    case Qt::EditRole:
        ...
        case Amount:
            return qint64(rec->bic + rec->debit);
        }
        break;
    case Qt::ToolTipRole:
    ...
    case Qt::ForegroundRole:
        ...
        if (rec->type == TransactionRecord::Generated || rec->type == TransactionRecord::StakeMint ||
                rec->type == TransactionRecord::StakeZBIC || rec->type == TransactionRecord::MNReward) {
        ...
        if (index.column() == Amount && (rec->bic + rec->debit) < 0) {

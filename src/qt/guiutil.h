...
/** Utility functions used by the BITCREXCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render BITCREXCOIN addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZbic = false);
...
// Parse "bitcrexcoin:" URI into recipient object, return true on successful parsing

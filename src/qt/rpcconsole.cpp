                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBICPathCustom = GetArg("-zbicbackuppath", "");
    ...
    if(!strzBICPathCustom.empty()) {
        ui->wallet_customzbicbackuppath->setText(QString::fromStdString(strzBICPathCustom));
        ui->wallet_customzbicbackuppath_label->setVisible(true);
        ui->wallet_customzbicbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBICPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BITCREXCOIN RPC console.") + "<br>" +

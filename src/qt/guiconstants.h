...
/* BitcrexCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BITCREXCOIN"
#define QAPP_ORG_DOMAIN "bitcrex.xyz"
#define QAPP_APP_NAME_DEFAULT "BITCREXCOIN-Qt"
#define QAPP_APP_NAME_TESTNET "BITCREXCOIN-Qt-testnet"

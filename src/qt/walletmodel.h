...
#ifndef BITCREXCOIN_QT_WALLETMODEL_H
#define BITCREXCOIN_QT_WALLETMODEL_H
...
/** Interface to BITCREXCOIN wallet from Qt view code. */
...
#endif // BITCREXCOIN_QT_WALLETMODEL_H

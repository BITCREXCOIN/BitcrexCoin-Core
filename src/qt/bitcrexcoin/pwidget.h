...
#include <QWidget>
#include <QString>
#include "qt/bitcrexcoin/prunnable.h"
...
class PWidget : public QWidget, public Runnable
{
    Q_OBJECT
public:
    explicit PWidget(BITCREXCOINGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    BITCREXCOINGUI* getWindow() { return this->window; }

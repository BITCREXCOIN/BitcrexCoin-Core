...
#include "qt/bitcrexcoin/forms/ui_masternodewizarddialog.h"
    ...
    walletModel(model)
{
    ...
    ui->lineEditPort->setPlaceholderText("e.g 36001");
    ...
    if(walletModel->isTestNetwork()){
        ...
        ui->lineEditPort->setText("36003");
    } else {
        ui->lineEditPort->setText("36001");
    }

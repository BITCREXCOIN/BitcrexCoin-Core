...
#include "config/bitcrexcoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalBic = 0;
    qint64 totalZbic = 0;
    QList<qreal> valuesBic;
    QList<qreal> valueszBic;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(BITCREXCOINGUI* _window);
    ~DashboardWidget();

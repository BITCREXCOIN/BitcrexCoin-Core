...
#include "qt/bitcrexcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/bitcrexcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(BITCREXCOINGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to BITCREXCOINGUI::handleRestart()

...
#include "qt/bitcrexcoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/bitcrexcoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(BITCREXCOINGUI* _window, QWidget *parent) :

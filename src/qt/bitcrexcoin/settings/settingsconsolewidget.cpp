...
#include "qt/bitcrexcoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/bitcrexcoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(BITCREXCOINGUI* _window, QWidget *parent) :

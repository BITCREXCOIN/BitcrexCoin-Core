...
#include "qt/bitcrexcoin/forms/ui_coldstakingwidget.h"
#include "qt/bitcrexcoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/bitcrexcoin/requestdialog.h"
...
#include "qt/bitcrexcoin/csrow.h"
...
ColdStakingWidget::ColdStakingWidget(BITCREXCOINGUI* parent) :
    PWidget(parent),
    ui(new Ui::ColdStakingWidget)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your BICs and let a hot node (24/7 online node)\nstake in your behalf, keeping the keys in a secure place offline."));
    ...
    ui->labelSubtitle2->setText(tr("Delegate or Accept BIC delegation"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select BIC outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 BIC" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}

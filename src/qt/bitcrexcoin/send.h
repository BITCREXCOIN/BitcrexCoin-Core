...
#include "qt/bitcrexcoin/contactsdropdown.h"
#include "qt/bitcrexcoin/sendmultirow.h"
#include "qt/bitcrexcoin/sendcustomfeedialog.h"
...
public:
    explicit SendWidget(BITCREXCOINGUI* parent);
    ~SendWidget();
...
private slots:
    void onBICSelected(bool _isBIC);
    void onSendClicked();
...
private:
    ...
    bool sendZbic(QList<SendCoinsRecipient> recipients);

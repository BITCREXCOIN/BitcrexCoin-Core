...
#ifndef BITCREXCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define BITCREXCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //BITCREXCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H

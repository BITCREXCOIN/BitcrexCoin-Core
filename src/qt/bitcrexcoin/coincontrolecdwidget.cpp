...
#include "qt/bitcrexcoin/coincontrolbicwidget.h"
#include "qt/bitcrexcoin/forms/ui_coincontrolbicwidget.h"

CoinControlBicWidget::CoinControlBicWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlBicWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select BIC Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("BIC");
    ...
    ui->labelValueAfter->setText("0.00 BIC");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 BIC");
    ui->labelValueFee->setText("0.00 BIC");
...
CoinControlBicWidget::~CoinControlBicWidget()
{
    delete ui;
}

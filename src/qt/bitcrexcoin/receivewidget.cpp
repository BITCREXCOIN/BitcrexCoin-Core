...
#include "qt/bitcrexcoin/forms/ui_receivewidget.h"
...
#include "qt/bitcrexcoin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(BITCREXCOINGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive BIC."));

...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, BITCREXCOINGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, BITCREXCOINGUI *gui, double posX = 3);

 ...
 * BITCREXCOIN system. There are three: the main network on which people trade goods
...
public:
    ...
    int BitcrexCoinBadBlockTime() const { return nBitcrexCoinBadBlockTime; }
    int BitcrexCoinBadBlocknBits() const { return nBitcrexCoinBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nBitcrexCoinBadBlockTime;
    unsigned int nBitcrexCoinBadBlocknBits;

...
BOOST_AUTO_TEST_CASE(ripemd160_testvectors) {
    ...
    TestRIPEMD160("abcdbcdbicefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq",
...
BOOST_AUTO_TEST_CASE(sha1_testvectors) {
    ...
    TestSHA1("abcdbcdbicefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq",
...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("abcdbcdbicefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq",
...
BOOST_AUTO_TEST_CASE(sha512_testvectors) {
    ...
    TestSHA512("abcdbcdbicefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq",

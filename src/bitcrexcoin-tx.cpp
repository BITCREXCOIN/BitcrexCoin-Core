...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitcrexCoin Core bitcrexcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitcrexcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcrexcoin transaction") + "\n" +
                               "  bitcrexcoin-tx [options] -create [commands]   " + _("Create hex-encoded bitcrexcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcrexcoin transaction

...
#ifndef BITCREXCOIN_ZBICWALLET_H
#define BITCREXCOIN_ZBICWALLET_H
...
public:
    CzBICWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBIC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBIC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //BITCREXCOIN_ZBICWALLET_H

...
This document provides guidelines for internationalization of the BITCREXCOIN Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to BITCREXCOIN network</numerusform>
            <numerusform>%n active connections to BITCREXCOIN network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcrexcoin_en.ts` remains unchanged.

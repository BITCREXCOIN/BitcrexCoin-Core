...
The build script we'll be using is contained in the BITCREXCOIN github repository ([contrib/gitian-build.py](https://github.com/bitcrexcoin-project/bitcrexcoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the BITCREXCOIN repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/BITCREXCOIN-Project/BITCREXCOIN/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, bitcrexcoin-detached-sigs, and bitcrexcoin GitHub repos.

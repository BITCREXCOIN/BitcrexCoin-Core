...
The script [extract-osx-sdk.sh](https://github.com/bitcrexcoin-project/bitcrexcoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
bitcrexcoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/bitcrexcoin-project/bitcrexcoin/blob/master/doc/README_osx.md) for troubleshooting tips.
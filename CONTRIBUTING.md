Contributing to BITCREXCOIN Core
============================

The BITCREXCOIN Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/bitcrexcoin-project/bitcrexcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BITCREXCOIN Core project, and is not to be
confused with overall BITCREXCOIN Network Protocol consensus changes.

Whether a pull request is merged into BITCREXCOIN Core rests with the project merge
...
Patches that change BITCREXCOIN consensus rules are considerably more involved than
normal because they affect the entire bicsystem and so must be preceded by
...
Where a patchset proposes to change the BITCREXCOIN consensus, it must have been
...
The project leader is the release manager for each BITCREXCOIN Core release.

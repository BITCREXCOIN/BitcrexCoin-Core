...
from fake_stake.base_test import BITCREXCOIN_FakeStakeTest

class zBICwrappedSerialsTest(BITCREXCOIN_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zBICs..." % DENOM_TO_USE)

...
from test_framework.bitcrexcoin_node import BitcrexCoinTestNode
...
class BITCREXCOIN_ColdStakingTest(BitcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(BitcrexCoinTestNode())
...
if __name__ == '__main__':
    BITCREXCOIN_ColdStakingTest().main()
